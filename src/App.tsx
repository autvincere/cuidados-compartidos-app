...
type AgreedTime = "" | "1 week" | "middle month" | "month";

interface iDatesCalendar {
  id: string;
  date: Date;
  father: boolean;
  mother: boolean;
...
function App() {
  ...
  const [startsWith, setStartsWith] = useState<"father" | "mother" | "">("");
  ...
  const generateWeekByWeek = () => {
    ...
    return dates.map((date, index) => {
      ...
      const isFatherTurn = startsWith === "father" ? firstTurn : !firstTurn;
